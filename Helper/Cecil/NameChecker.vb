...
#Region " Methods "
        ...
        Public Shared Function IsRenamable(type As TypeDefinition) As Boolean
            ...
            Return Not type.FullName = "<Module>" AndAlso Not type.Name.StartsWith("<") AndAlso Not type.Name.StartsWith("__") AndAlso Not type.IsImport AndAlso Not type.IsSerializable
        ...
        Public Shared Function IsRenamable(method As MethodDefinition, Optional ByVal Force As Boolean = False) As Boolean
            If method IsNot Nothing Then
                If Force Then
                    If method.HasBody Then
                        If Finder.AccessorMethods(method.DeclaringType).Contains(method) Then
                            ...
                            'Return Not Finder.HasCustomAttributeByName(method, "DebuggerHiddenAttribute")
                        End If
                    End If
                End If
                ...
                'Return Not method.IsRuntimeSpecialName AndAlso Not method.IsRuntime AndAlso Not method.IsSpecialName AndAlso Not method.IsConstructor AndAlso Not method.HasOverrides AndAlso Not method.IsVirtual AndAlso Not method.IsAbstract AndAlso Not method.IsHideBySig AndAlso Not method.Name.EndsWith("GetEnumerator")

                Return Not method.IsRuntimeSpecialName AndAlso Not method.IsRuntime AndAlso Not method.IsConstructor AndAlso Not method.HasOverrides AndAlso Not method.IsVirtual AndAlso Not method.IsAbstract AndAlso Not method.IsHideBySig AndAlso Not method.Name.EndsWith("GetEnumerator")
                'Return Not method.IsRuntimeSpecialName AndAlso Not method.IsRuntime AndAlso Not method.IsConstructor AndAlso Not method.Name.EndsWith("GetEnumerator")
            End If
            Return False
        End Function
        ...
        Public Shared Function IsRenamable(prop As PropertyDefinition) As Boolean
            If prop IsNot Nothing Then
                ...
                'Return renamable AndAlso Not prop.IsRuntimeSpecialName AndAlso Not prop.IsSpecialName AndAlso Not IsSerializable AndAlso Not prop.DeclaringType.IsGenericInstance
            End If
            Return False
        End Function
        ...
        Public Shared Function IsRenamable(field As FieldDefinition) As Boolean
            If field.IsPrivate Then
                If (Not field.IsRuntimeSpecialName AndAlso Not field.DeclaringType.HasGenericParameters AndAlso Not field.DeclaringType.IsGenericInstance AndAlso Not field.IsSpecialName AndAlso Not field.IsPInvokeImpl) Then
                    Return True
                End If
            Else
                ...
                End If
            End If
            'Dim IsCompilerGenerated As Boolean = Finder.HasCustomAttributeByName(field, "CompilerGeneratedAttribute")

            'If (Not field.IsRuntimeSpecialName AndAlso Not IsSerializable AndAlso Not field.DeclaringType.IsGenericInstance) And Not field.IsPInvokeImpl AndAlso Not field.IsSpecialName Then
            '    Return True
            'End If
            Return False
        End Function
