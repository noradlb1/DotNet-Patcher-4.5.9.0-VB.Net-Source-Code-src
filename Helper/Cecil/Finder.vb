...
#Region " Methods "
        ...
        Public Shared Function HasCustomAttributeByName(member As IMemberDefinition, CaName$) As Boolean
            Return Enumerable.Any(member.CustomAttributes, Function(ca) ca.AttributeType.Name = CaName)
        End Function

        Public Shared Function HasCustomAttributeByName(member As AssemblyDefinition, CaName$, IsAssemblyDef As Boolean) As Boolean
            Return Enumerable.Any(member.CustomAttributes, Function(ca) ca.AttributeType.Name = CaName)
        End Function
