...
#Region " Methods "
        ...
        Friend Shared Function RenameMethod(method As MethodDefinition) As MethodDefinition
        ...
        Friend Shared Function RenameInterfaceMethod(method As MethodDefinition) As MethodDefinition
            Dim MethodOriginal = method.Name
            Dim MethodPublicObf = Randomizer.GenerateNew()

            If Not Finder.FindGenericParameter(method) AndAlso Not Finder.HasCustomAttributeByName(method, "DebuggerHiddenAttribute") Then
                method.Name = Mapping.RenameInterfaceMethodMember(method, MethodPublicObf)
            End If
        ...
        ''' <param name="obfuscatedN"></param> 
        Friend Shared Sub RenameFields(type As TypeDefinition, prop As PropertyDefinition, originalN$, obfuscatedN$)
            If type.HasFields Then
                For Each field As FieldDefinition In (From f In type.Fields
                    ...
                    For Each ca In (From c In field.CustomAttributes
                        ...
                        RenameField(field, "_" & obfuscatedN)
                        Exit For
                    Next
                Next
            End If
