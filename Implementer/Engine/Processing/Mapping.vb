...
#Region " Fields "
        ...
        Private Shared m_ObfInterfaceMethods As Dictionary(Of MethodDefinition, String)
#End Region
...
#Region " Constructor "
        Shared Sub New()
            ...
            m_ObfInterfaceMethods = New Dictionary(Of MethodDefinition, String)
        End Sub
#End Region
...
#Region " Methods "
        ...
        Friend Shared Function RenameInterfaceMethodMember(Member As MethodDefinition, ByRef MemberObfuscated$) As String
            If Not m_ObfMethods.ContainsKey(Member) Then
                m_ObfInterfaceMethods.Add(Member, MemberObfuscated)
                Tasks.RaiseRenamedItemEvent(New RenamedItem(RenamedItemType.ItemType.Methods, Member.Name, MemberObfuscated))
            Else
                MemberObfuscated = m_ObfInterfaceMethods.Item(Member)
            End If
            Return MemberObfuscated
        End Function
